...
function startwatch() {
	...
	watch(['app/js/src/**/*.js'], parallel(libs, scripts));
...
exports.default = parallel(images, styles, libs, scripts, browsersync, startwatch);
exports.build = series(env, parallel(images, styles, libs, scripts));